...
<div id="content" class="categorias index">
    ...
    <tr>
            ...
            <th><?php echo $paginator->sort('Padre', 'Padre.nombre');?></th>
    ...
    ?>
            <tr<?php echo $class;?>>
                    ...
                    <td class="actions">
                            <?php echo $html->link(__('View', true), array('action' => 'view', 'admin' => true, $categoria['Categoria']['id'])); ?>
                            <?php echo $html->link(__('Edit', true), array('action' => 'edit', 'admin' => true, $categoria['Categoria']['id'])); ?>
                            <?php echo $html->link(__('Delete', true), array('action' => 'delete', 'admin' => true, $categoria['Categoria']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $categoria['Categoria']['id'])); ?>
                    </td>
            </tr>
    <?php endforeach; ?>
    </table>
